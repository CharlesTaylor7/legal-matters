...
const Matters = () => {
  ...
  const {
    data: matterDetail,
    isLoading: isLoadingMatterDetail,
  } = useMatterQuery(
    selectedCustomerId ?? 0,
    selectedMatterId ?? 0,
    // Only fetch when both IDs are valid and a modal is open
    { enabled: !!selectedCustomerId && !!selectedMatterId && (isViewModalOpen || isEditModalOpen) }
  );
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      {/* Loading States */}
      {isLoadingCustomers && <div className="loading loading-spinner loading-lg mx-auto my-8"></div>}
        ...
        <div className="overflow-x-auto bg-base-100 rounded-lg shadow">
          {isLoadingMatters ? (
                  ...
                  <tr key={matter.id} className="hover">
                    ...
                    <td className="flex gap-2">
                      <button 
                        ...
                        onClick={() => handleViewMatter(matter.customerId, matter.id)}
                      >
                        View
                      </button>
                      <button 
                        className="btn btn-sm btn-outline btn-accent" 
                        onClick={() => handleEditMatter(matter.customerId, matter.id)}
                      >
                        Edit
                      </button>
                    </td>
            ...
            <div className="p-8 text-center">
              <p className="text-lg text-base-content/70">No matters found for this customer.</p>
            </div>
          )}
        </div>
      )}
            ...
            {isLoadingMatterDetail ? (
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  ...
                  <div>
                    <h4 className="font-medium text-sm opacity-70">Open Date</h4>
                    <p>{formatDate(matterDetail.openDate)}</p>
                  </div>
                </div>
                
                <div className="mb-4">
                  <h4 className="font-medium text-sm opacity-70">Description</h4>
                  <p className="whitespace-pre-wrap">{matterDetail.description || "No description provided."}</p>
                </div>
                ...
                <div className="modal-action">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      handleEditMatter(matterDetail.customerId, matterDetail.id);
                    }}
                  >
                    Edit
                  </button>
